...
tasks {
    register<Jar>("paperclipJar") {
        ...
        dependsOn("shadowJar", ":dashspigot-server:remap")
        ...
        doFirst {
            val inTask = project(":dashspigot-server").tasks["remap"] as RemapTask
            val diffFile = temporaryDir.resolve("dashspigot.patch")
            ...
            properties.setProperty("patch", "dashspigot.patch")
